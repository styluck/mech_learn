...
if __name__ == '__main__':
    ...
    # KMeans clustering
    k = 7
    kmeans = KMeans(n_clusters=k, init='k-means++', n_init=8, max_iter=300, random_state=random_state+1000)
    ...
    plt.scatter(centroids_kmeans[:, 0], centroids_kmeans[:, 1], c='k', marker='x', s=200, label='Centroids')
